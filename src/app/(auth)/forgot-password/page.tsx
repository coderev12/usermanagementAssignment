...
export default function ForgotPassword() {
  ...
  return (
    <>
      <ToastContainer />
      <div className="mt-[100px] p-[100px] h-max w-screen flex justify-center items-center">
        <div className="w-[500px] p-5 rounded-lg  shadow-2xl shadow-gray-900/10">
          ...
          <form onSubmit={submit}>
            <div className="mt-5">
              ...
              <input
                type="email"
                placeholder="shivansh@gmail.com"
