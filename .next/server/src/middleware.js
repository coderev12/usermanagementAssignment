...
var jwt = __webpack_require__(738);
...
async function middleware(request) {
    ...
    if (token == null && administratorRoute.includes(pathname)) {
        return NextResponse.redirect(new URL("/administrator/login?error=You dont have the access to this route", request.url));
    }
    ...
    if (user?.role == "User" && (adminProtectedRoute.includes(pathname) || managerProtectedRoute.includes(pathname))) {
        return NextResponse.redirect(new URL("/dashboard?error=Don't have the access to this page", request.url));
    }
}

;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fsrc%2Fmiddleware.ts&page=%2Fsrc%2Fmiddleware&rootDir=C%3A%5CUsers%5Cshiva%5CDownloads%5CUser_managment_Assignment%5CUser_management_assignment&matchers=&preferredRegion=&middlewareConfig=e30%3D!
...
/******/ var __webpack_exports__ = (__webpack_exec__(454));
